...
生成时间：2026-06-10T02:07:09.544Z

## 工具链环境

- 工具链：weapp-vite fa75b2f / Node 24.14.1（`weapp-vite-fa75b2f-node24`）
...
- 包版本：weapp-vite@6.16.43、wevu@6.16.43、@dcloudio/vite-plugin-uni@3.0.0-alpha-5010220260529001

## 结论

- 当前差距主要来自 JS 固定运行时成本：weapp-vite + wevu 的 JS 为 442.4 KB，uni-app vite vue3 为 68.7 KB，差值 373.6 KB。
- wevu 的 vendor JS 为 435.6 KB，uni-app 的 vendor JS 为 64.6 KB，vendor 差值 371.0 KB，这是最主要的大头。
- 对比 weapp-vite 原生，wevu 增加的运行时税约 436.0 KB。业务页面 JS 本身只有 6.1 KB，不是主要问题。
...
| ----------------------------- | -------: | ------: | ------: | -------: | --------: | ------: | ------: | -------: |
| weapp-vite + wevu             | 444.7 KB | 98.1 KB | 81.2 KB | 442.4 KB |  435.6 KB |  6.1 KB |   99.5% |   51.06x |
| weapp-vite + wevu performance | 445.7 KB | 98.5 KB | 81.5 KB | 443.3 KB |  435.6 KB |  6.6 KB |   99.5% |   51.17x |
...
| --------------------------------- | -------: | ------: | ------: | -------- | ------ |
| weapp-vendors/wevu-watch.js       | 237.7 KB | 46.3 KB | 37.1 KB | js       | vendor |
...
| weapp-vendors/wevu-router.js      |   9.8 KB |  2.2 KB |  1.9 KB | js       | vendor |
| pages/index/index.js              |   5.9 KB |  1.8 KB |  1.6 KB | js       | page   |
| weapp-vendors/wevu-computed.js    |   1.2 KB |  0.6 KB |  0.5 KB | js       | vendor |
...
| pages/index/index.wxss  | 0.6 KB | 0.3 KB | 0.3 KB | style    | page  |
...
| 源包文件                 | 压缩后体积 brotli |
| ------------------------ | ----------------: |
| dist/router.mjs          |            6.1 KB |
| dist/ref-CRwjgX_d.mjs    |            3.4 KB |
| dist/router-BiJKkvy7.mjs |            3.0 KB |
| dist/store-B9C0AuaO.mjs  |            1.6 KB |
| dist/vue-demi.mjs        |            1.7 KB |
